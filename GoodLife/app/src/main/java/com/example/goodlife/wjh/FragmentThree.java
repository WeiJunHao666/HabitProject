...
import com.example.goodlife.zsl.activity.DynamicPageActivity;
...
import com.example.goodlife.zsl.activity.LoginPageActivity;
...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        root =inflater.inflate(R.layout.fragment_three_page, container, false);
        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.set:
                    ...
                    break;
                case R.id.img_head:
                    Intent intent1 = new Intent(getActivity().getApplicationContext(), LoginPageActivity.class);
                ...
                case R.id.btn_dynamic:
                    Intent intent5 = new Intent(getActivity().getApplicationContext(), DynamicPageActivity.class);
