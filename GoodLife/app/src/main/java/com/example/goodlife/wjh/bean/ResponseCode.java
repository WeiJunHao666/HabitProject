...
public class ResponseCode {
    ...
    public static final int CREATE_SUCCESS = 2004;
    public static final int CLOCK_SUCCESS = 2005;
    ...
    public static final int CREATE_FAILED = 3004;
    public static final int CLOCK_FAILED = 3005;
}
